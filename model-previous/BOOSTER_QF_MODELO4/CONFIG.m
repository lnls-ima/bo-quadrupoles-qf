...
parms.fmap_fname    = '/opt/lnls-data/sirius_mml/magnet_modelling/MM3D/QF_Booster/2013-08-19 Quadrupolo_Booster_QF_Modelo 4_-32_32mm_-450_450mm.txt';
...
parms.rk_traj             = []; %'/opt/MatlabMiddleLayer/Release/lnls/fac_scripts/sirius/magnet_modelling/CONFIGS/QF_Booster/fieldmap_analysis.mat';
parms.perp_grid.points    = linspace(-18,18,37) * mm;           % perpendicular grid points for multipole and transfer map calcs
parms.perp_grid.monomials = [1,3,5,7,9,11,13,15,17];            % monomials for multipole fitting
